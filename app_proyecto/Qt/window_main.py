...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHeightForWidth(
            self.menu_opciones.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy1.setHeightForWidth(
            self.btn_modificar.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy1.setHeightForWidth(
            self.btn_consultar.sizePolicy().hasHeightForWidth()
        )
        ...
        self.frame.setGeometry(QRect(270, 190, 311, 321))
        self.frame.setFrameShape(QFrame.NoFrame)
        self.frame.setFrameShadow(QFrame.Raised)
        self.frame.setLineWidth(1)
        self.verticalLayoutWidget = QWidget(self.frame)
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.verticalLayoutWidget.setGeometry(QRect(9, 9, 291, 301))
        self.grafica_torta = QVBoxLayout(self.verticalLayoutWidget)
        self.grafica_torta.setObjectName("grafica_torta")
        ...
        self.notificacion.setAlignment(
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menu_opciones.setTitle(
            QCoreApplication.translate("MainWindow", "Opciones", None)
        )
        self.btn_agregar.setText(
            QCoreApplication.translate("MainWindow", "Agregar artículo", None)
        )
        self.btn_eliminar.setText(
            QCoreApplication.translate("MainWindow", "Eliminar artículo", None)
        )
        self.btn_modificar.setText(
            QCoreApplication.translate("MainWindow", "Modificar artículo", None)
        )
        self.btn_consultar.setText(
            QCoreApplication.translate("MainWindow", "Consultar Stock", None)
        )
        self.titulo.setText(
            QCoreApplication.translate("MainWindow", "Electr\u00f3nica del oeste", None)
        )
        self.subtitulo.setText(
            QCoreApplication.translate(
                "MainWindow", "Bienvenido, seleccione la opción a realizar", None
            )
        )
