...
"}")
    ...
    def retranslateUi(self, Modificar):
        ...
        self.btn_aceptar.setText(QCoreApplication.translate("Modificar", u"Aceptar", None))
        self.btn_cancelar.setText(QCoreApplication.translate("Modificar", u"Cancelar", None))
